...
class BehavioralAnalyzer:
    ...
    def __init__(self):
        # Эмоциональные маркеры для анализа
        self.emotion_patterns = {
            'positive': {
                'keywords': ['хорошо', 'отлично', 'прекрасно', 'радость', 'счастлив', 'весело', 'классно', 'супер'],
                'emojis': ['😊', '😄', '🌟', '✨', '😍', '🎉', '👍'],
                'punctuation': ['!!!!', '!!!']
            },
            'negative': {
                'keywords': ['плохо', 'ужасно', 'грустно', 'расстроен', 'проблема', 'беда', 'плачу', 'больно'],
                'emojis': ['😢', '😭', '😔', '💔', '😞', '😪'],
                'punctuation': ['...', ':(']
            },
            'angry': {
                'keywords': ['злой', 'сердитый', 'раздражает', 'бесит', 'ненавижу', 'достал', 'надоел'],
                'emojis': ['😠', '😡', '🤬', '💢'],
                'punctuation': ['!!!']
            },
            'anxious': {
                'keywords': ['волнуюсь', 'переживаю', 'страшно', 'боюсь', 'тревожно', 'нервничаю', 'паника'],
                'emojis': ['😰', '😱', '😟', '😨'],
                'punctuation': ['...']
            },
            'excited': {
                'keywords': ['восторг', 'восхитительно', 'невероятно', 'потрясающе', 'обожаю', 'в шоке'],
                'emojis': ['🤩', '😍', '🔥', '⭐', '🚀'],
                'punctuation': ['!!!!', '!!!']
            },
            'tired': {
                'keywords': ['устал', 'утомлен', 'измучен', 'нет сил', 'сонный', 'вымотан', 'выжат'],
                'emojis': ['😴', '💤', '😵'],
                'punctuation': ['...']
            },
            'confused': {
